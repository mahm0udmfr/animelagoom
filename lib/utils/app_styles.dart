...
class AppStyles {
  ...
  static TextStyle semiBold20greyColorInter = GoogleFonts.inter(
  ...
  static TextStyle regular14greyColorRoboto = GoogleFonts.roboto(
      fontSize: 14, fontWeight: FontWeight.w400, color: AppColors.greyColor);
  static TextStyle regular15greyColorRoboto = GoogleFonts.roboto(
      fontSize: 15, fontWeight: FontWeight.w400, color: AppColors.greyColor);
  static TextStyle regular16greyColorRoboto = GoogleFonts.roboto(
      fontSize: 16, fontWeight: FontWeight.w400, color: AppColors.greyColor);
  static TextStyle black14greyColorRoboto = GoogleFonts.roboto(
      fontSize: 14, fontWeight: FontWeight.w900, color: AppColors.greyColor);
  static TextStyle bold20greyColorRoboto = GoogleFonts.roboto(
      fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.greyColor);

  static TextStyle bold24BlockRoboto = GoogleFonts.roboto(
